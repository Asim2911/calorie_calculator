...
{
    $query = "update calorie_intake_table set Total_Calorie_Intake='$Total_Calorie_Intake' ,Target_Acheived_Intake='$Target_Acheived_Intake' where User_Name='$User_Name' ";
