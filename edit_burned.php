...
{
    $query = "update calorie_burned_table set Total_Calorie_Burned='$Total_Calorie_Burned' ,Target_Acheived_Burned='$Target_Acheived_Burned' where User_Name='$User_Name' ";
